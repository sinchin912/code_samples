...
/**
 * Provides the local service utility for Drive. This utility wraps
 * <code>com.trantorinc.synergy.lms.core.service.impl.DriveLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DriveLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.trantorinc.synergy.lms.core.service.impl.DriveLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Drive addDrive(Drive drive) {
		return getService().addDrive(drive);
	}
	 ...
	 */
	public static Drive createDrive(long driveId) {
		return getService().createDrive(driveId);
	}
	 ...
	 */
	public static Drive deleteDrive(Drive drive) {
		return getService().deleteDrive(drive);
	}
	 ...
	 */
	public static Drive deleteDrive(long driveId) throws PortalException {
		return getService().deleteDrive(driveId);
	}
	...
	public static Drive fetchDrive(long driveId) {
		return getService().fetchDrive(driveId);
	}

	public static String findFolderIdByFolderName(String folderName) {
		return getService().findFolderIdByFolderName(folderName);
	}
	 ...
	 * @throws PortalException if a drive with the primary key could not be found
	 */
	public static Drive getDrive(long driveId) throws PortalException {
		return getService().getDrive(driveId);
	}
	 ...
	 */
	public static List<Drive> getDrives(int start, int end) {
		return getService().getDrives(start, end);
	}
	...
	public static int getDrivesCount() {
		return getService().getDrivesCount();
	}
	 ...
	 */
	public static Drive updateDrive(Drive drive) {
		return getService().updateDrive(drive);
	}

	public static DriveLocalService getService() {
		return _service;
	}

	private static volatile DriveLocalService _service;
