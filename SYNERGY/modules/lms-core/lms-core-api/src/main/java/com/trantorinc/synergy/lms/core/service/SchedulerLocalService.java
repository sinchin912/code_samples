...
/**
 * Provides the local service interface for Scheduler. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SchedulerLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SchedulerLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.trantorinc.synergy.lms.core.service.impl.SchedulerLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the scheduler local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SchedulerLocalServiceUtil} if injection and service tracking are not available.
	 */
