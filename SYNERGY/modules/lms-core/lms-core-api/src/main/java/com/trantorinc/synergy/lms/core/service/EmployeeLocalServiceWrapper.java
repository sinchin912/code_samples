...
public class EmployeeLocalServiceWrapper
	 ...
	 */
	@Override
	public com.trantorinc.synergy.lms.core.model.Employee addEmployee(
		com.trantorinc.synergy.lms.core.model.Employee employee) {
	 ...
	 */
	@Override
	public com.trantorinc.synergy.lms.core.model.Employee createEmployee(
		String ecode) {

		return _employeeLocalService.createEmployee(ecode);
	}
	 ...
	 */
	@Override
	public com.trantorinc.synergy.lms.core.model.Employee deleteEmployee(
		com.trantorinc.synergy.lms.core.model.Employee employee) {
	...
	public com.trantorinc.synergy.lms.core.model.Employee deleteEmployee(
		...
		return _employeeLocalService.deleteEmployee(ecode);
	}
	...
	@Override
	public com.trantorinc.synergy.lms.core.model.Employee fetchEmployee(
		String ecode) {

		return _employeeLocalService.fetchEmployee(ecode);
	}
	...
	public java.util.List<com.trantorinc.synergy.lms.core.model.Employee>
		...
		return _employeeLocalService.findAllActiveEmployees();
	}
	...
	@Override
	public java.util.List<com.trantorinc.synergy.lms.core.model.Employee>
		findAnniversaries(java.util.Date date) {

		return _employeeLocalService.findAnniversaries(date);
	}

	@Override
	public java.util.List<com.trantorinc.synergy.lms.core.model.Employee>
		findBirthdays(java.util.Date date) {

		return _employeeLocalService.findBirthdays(date);
	}

	@Override
	public java.util.List<com.trantorinc.synergy.lms.core.model.Employee>
		findByDoj(java.util.Date onDate) {

		return _employeeLocalService.findByDoj(onDate);
	}
	...
	public java.util.List<com.trantorinc.synergy.lms.core.model.Employee>
		...
		return _employeeLocalService.findManagerReporters(manager);
	}

	@Override
	public java.util.List<String> findUniqueAccounts() {
		return _employeeLocalService.findUniqueAccounts();
	}
	 ...
	 */
	@Override
	public com.trantorinc.synergy.lms.core.model.Employee getEmployee(
			String ecode)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _employeeLocalService.getEmployee(ecode);
	}
	 ...
	 */
	@Override
	public com.trantorinc.synergy.lms.core.model.Employee updateEmployee(
		com.trantorinc.synergy.lms.core.model.Employee employee) {
