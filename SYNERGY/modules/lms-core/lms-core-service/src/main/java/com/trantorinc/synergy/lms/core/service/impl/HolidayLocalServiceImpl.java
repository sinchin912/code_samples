...
import com.trantorinc.synergy.lms.core.service.base.HolidayLocalServiceBaseImpl;
 ...
 */
@Component(
	property = "model.class.name=com.trantorinc.synergy.lms.core.model.Holiday",
...
public class HolidayLocalServiceImpl extends HolidayLocalServiceBaseImpl {
	public List<Holiday> findHolidaysByYear(int year) {
		return holidayFinder.findHolidaysByYear(year);
	}
}