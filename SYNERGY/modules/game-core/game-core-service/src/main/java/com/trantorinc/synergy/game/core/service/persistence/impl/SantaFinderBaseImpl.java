 ...
 * @generated
 */
public abstract class SantaFinderBaseImpl extends BasePersistenceImpl<Santa> {

	public SantaFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return santaPersistence.getBadColumnNames();
	}
