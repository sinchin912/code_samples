...
/**
 * Provides the local service utility for GameTimeline. This utility wraps
 * <code>com.trantorinc.synergy.game.core.service.impl.GameTimelineLocalServiceImpl</code> and
 ...
 * @generated
 */
public class GameTimelineLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.trantorinc.synergy.game.core.service.impl.GameTimelineLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static GameTimeline addGameTimeline(GameTimeline gameTimeline) {
		return getService().addGameTimeline(gameTimeline);
	}
	 ...
	 */
	public static GameTimeline createGameTimeline(String name) {
		return getService().createGameTimeline(name);
	}
	 ...
	 */
	public static GameTimeline deleteGameTimeline(GameTimeline gameTimeline) {
		return getService().deleteGameTimeline(gameTimeline);
	}
	 ...
	 */
	public static GameTimeline deleteGameTimeline(String name)
		throws PortalException {

		return getService().deleteGameTimeline(name);
	}
	...
	public static GameTimeline fetchGameTimeline(String name) {
		return getService().fetchGameTimeline(name);
	}

	public static List<GameTimeline> getCalibratedTimeline() {
		return getService().getCalibratedTimeline();
	}
	 ...
	 * @throws PortalException if a game timeline with the primary key could not be found
	 */
	public static GameTimeline getGameTimeline(String name)
		throws PortalException {

		return getService().getGameTimeline(name);
	}
	 ...
	 */
	public static List<GameTimeline> getGameTimelines(int start, int end) {
		return getService().getGameTimelines(start, end);
	}
	 ...
	 */
	public static int getGameTimelinesCount() {
		return getService().getGameTimelinesCount();
	}
	 ...
	 */
	public static GameTimeline updateGameTimeline(GameTimeline gameTimeline) {
		return getService().updateGameTimeline(gameTimeline);
	}

	public static GameTimelineLocalService getService() {
		return _service;
	}

	private static volatile GameTimelineLocalService _service;
