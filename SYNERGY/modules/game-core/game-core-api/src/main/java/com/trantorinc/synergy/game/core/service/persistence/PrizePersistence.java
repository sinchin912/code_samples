...
/**
 * The persistence interface for the prize service.
 *
 * <p>
 ...
 */
@ProviderType
public interface PrizePersistence extends BasePersistence<Prize> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PrizeUtil} to access the prize persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public void cacheResult(java.util.List<Prize> prizes);
	 ...
	 * @return the prizes
	 */
	public java.util.List<Prize> findAll();
	 ...
	 */
	public java.util.List<Prize> findAll(int start, int end);
	...
	public java.util.List<Prize> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Prize>
			orderByComparator);
