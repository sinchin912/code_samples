...
/**
 * Provides the local service interface for Santa. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SantaLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SantaLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.trantorinc.synergy.game.core.service.impl.SantaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the santa local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SantaLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public List<Santa> findSantaByEcodeAndYear(String ecode, int year);

	public List<Santa> findSantaBySantaEcodeAndYear(
