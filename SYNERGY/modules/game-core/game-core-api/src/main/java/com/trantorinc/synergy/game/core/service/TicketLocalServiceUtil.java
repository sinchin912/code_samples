 ...
 * <code>com.trantorinc.synergy.game.core.service.impl.TicketLocalServiceImpl</code> and
...
public class TicketLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.trantorinc.synergy.game.core.service.impl.TicketLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static List<Ticket> findTicketByYear(int year) {
		return getService().findTicketByYear(year);
	}

	public static List<Ticket> findTicketByYearAndEcode(
		int year, String ecode) {

		return getService().findTicketByYearAndEcode(year, ecode);
	}

	public static List<Ticket> findTicketByYearAndNumber(
		int year, String ticketNumber) {

		return getService().findTicketByYearAndNumber(year, ticketNumber);
	}
