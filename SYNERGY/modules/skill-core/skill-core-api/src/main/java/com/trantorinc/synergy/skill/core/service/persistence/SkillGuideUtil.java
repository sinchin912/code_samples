...
/**
 * The persistence utility for the skill guide service. This utility wraps <code>com.trantorinc.synergy.skill.core.service.persistence.impl.SkillGuidePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see SkillGuidePersistence
 * @generated
 */
public class SkillGuideUtil {
	 ...
	 */
	public static void clearCache(SkillGuide skillGuide) {
		getPersistence().clearCache(skillGuide);
	}
	 ...
	 */
	public static Map<Serializable, SkillGuide> fetchByPrimaryKeys(
	 ...
	 */
	public static List<SkillGuide> findWithDynamicQuery(
	...
	public static List<SkillGuide> findWithDynamicQuery(
		DynamicQuery dynamicQuery, int start, int end,
		OrderByComparator<SkillGuide> orderByComparator) {
	 ...
	 */
	public static SkillGuide update(SkillGuide skillGuide) {
		return getPersistence().update(skillGuide);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static SkillGuide update(
		SkillGuide skillGuide, ServiceContext serviceContext) {

		return getPersistence().update(skillGuide, serviceContext);
	}
	 ...
	 */
	public static void cacheResult(SkillGuide skillGuide) {
		getPersistence().cacheResult(skillGuide);
	}
	 ...
	 */
	public static void cacheResult(List<SkillGuide> skillGuides) {
		getPersistence().cacheResult(skillGuides);
	}
	 ...
	 */
	public static SkillGuide create(long guideId) {
	 ...
	 */
	public static SkillGuide remove(long guideId)
		throws com.trantorinc.synergy.skill.core.exception.
			NoSuchSkillGuideException {

		return getPersistence().remove(guideId);
	}

	public static SkillGuide updateImpl(SkillGuide skillGuide) {
		return getPersistence().updateImpl(skillGuide);
	}
	 ...
	 * @throws NoSuchSkillGuideException if a skill guide with the primary key could not be found
	 */
	public static SkillGuide findByPrimaryKey(long guideId)
		throws com.trantorinc.synergy.skill.core.exception.
			NoSuchSkillGuideException {
	 ...
	 */
	public static SkillGuide fetchByPrimaryKey(long guideId) {
	 ...
	 */
	public static List<SkillGuide> findAll() {
	 ...
	 */
	public static List<SkillGuide> findAll(int start, int end) {
	...
	public static SkillGuidePersistence getPersistence() {
		return _persistence;
	}

	private static volatile SkillGuidePersistence _persistence;
