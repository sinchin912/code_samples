...
/**
 * The persistence utility for the skill rejection comment service. This utility wraps <code>com.trantorinc.synergy.skill.core.service.persistence.impl.SkillRejectionCommentPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see SkillRejectionCommentPersistence
 * @generated
 */
public class SkillRejectionCommentUtil {
	 ...
	 */
	public static void clearCache(SkillRejectionComment skillRejectionComment) {
		getPersistence().clearCache(skillRejectionComment);
	}
	 ...
	 */
	public static Map<Serializable, SkillRejectionComment> fetchByPrimaryKeys(
	 ...
	 */
	public static List<SkillRejectionComment> findWithDynamicQuery(
	 ...
	 */
	public static SkillRejectionComment update(
		SkillRejectionComment skillRejectionComment) {

		return getPersistence().update(skillRejectionComment);
	}
	...
	public static SkillRejectionComment update(
		...
		return getPersistence().update(skillRejectionComment, serviceContext);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(skillRejectionComment);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(skillRejectionComments);
	}
	 ...
	 */
	public static SkillRejectionComment create(long commentId) {
	 ...
	 */
	public static SkillRejectionComment remove(long commentId)
		throws com.trantorinc.synergy.skill.core.exception.
			NoSuchSkillRejectionCommentException {

		return getPersistence().remove(commentId);
	}

	public static SkillRejectionComment updateImpl(
		SkillRejectionComment skillRejectionComment) {

		return getPersistence().updateImpl(skillRejectionComment);
	}
	 ...
	 * @throws NoSuchSkillRejectionCommentException if a skill rejection comment with the primary key could not be found
	 */
	public static SkillRejectionComment findByPrimaryKey(long commentId)
		throws com.trantorinc.synergy.skill.core.exception.
			NoSuchSkillRejectionCommentException {
	 ...
	 */
	public static SkillRejectionComment fetchByPrimaryKey(long commentId) {
	 ...
	 */
	public static List<SkillRejectionComment> findAll() {
	 ...
	 */
	public static List<SkillRejectionComment> findAll(int start, int end) {
	...
	public static SkillRejectionCommentPersistence getPersistence() {
		return _persistence;
	}

	private static volatile SkillRejectionCommentPersistence _persistence;
