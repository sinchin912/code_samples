...
/**
 * Provides the local service interface for SkillGuide. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SkillGuideLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SkillGuideLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.trantorinc.synergy.skill.core.service.impl.SkillGuideLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the skill guide local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SkillGuideLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public SkillGuide addSkillGuide(SkillGuide skillGuide);
	...
	public SkillGuide createSkillGuide(long guideId);
	...
	public SkillGuide deleteSkillGuide(long guideId) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public SkillGuide deleteSkillGuide(SkillGuide skillGuide);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SkillGuide fetchSkillGuide(long guideId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SkillGuide getSkillGuide(long guideId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SkillGuide> getSkillGuides(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SkillGuide updateSkillGuide(SkillGuide skillGuide);
