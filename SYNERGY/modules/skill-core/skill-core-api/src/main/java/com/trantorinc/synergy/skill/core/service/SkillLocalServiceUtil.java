 ...
 * <code>com.trantorinc.synergy.skill.core.service.impl.SkillLocalServiceImpl</code> and
...
public class SkillLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.trantorinc.synergy.skill.core.service.impl.SkillLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Skill deleteSkill(long skillId) throws PortalException {
	 ...
	 * @return the skill that was removed
	 */
	public static Skill deleteSkill(Skill skill) {
	...
	public static Skill fetchSkill(long skillId) {
		return getService().fetchSkill(skillId);
	}

	public static List<Skill> findSkillsByEmployee(String ecode) {
		return getService().findSkillsByEmployee(ecode);
	}

	public static List<Skill> findSkillsByReviewer(String reviewerEmail) {
		return getService().findSkillsByReviewer(reviewerEmail);
	}
	 ...
	 * @throws PortalException if a skill with the primary key could not be found
	 */
	public static Skill getSkill(long skillId) throws PortalException {
	 ...
	 */
	public static List<Skill> getSkills(int start, int end) {
	 ...
	 */
	public static Skill updateSkill(Skill skill) {
	...
	private static volatile SkillLocalService _service;
