...
public interface CertificateLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.trantorinc.synergy.skill.core.service.impl.CertificateLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the certificate local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CertificateLocalServiceUtil} if injection and service tracking are not available.
	 */
