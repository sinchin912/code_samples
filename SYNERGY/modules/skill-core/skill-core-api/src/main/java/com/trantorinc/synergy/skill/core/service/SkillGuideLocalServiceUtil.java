...
/**
 * Provides the local service utility for SkillGuide. This utility wraps
 * <code>com.trantorinc.synergy.skill.core.service.impl.SkillGuideLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SkillGuideLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.trantorinc.synergy.skill.core.service.impl.SkillGuideLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static SkillGuide addSkillGuide(SkillGuide skillGuide) {
		return getService().addSkillGuide(skillGuide);
	}
	 ...
	 */
	public static SkillGuide createSkillGuide(long guideId) {
		return getService().createSkillGuide(guideId);
	}
	 ...
	 */
	public static SkillGuide deleteSkillGuide(long guideId)
		throws PortalException {

		return getService().deleteSkillGuide(guideId);
	}
	 ...
	 * @return the skill guide that was removed
	 */
	public static SkillGuide deleteSkillGuide(SkillGuide skillGuide) {
		return getService().deleteSkillGuide(skillGuide);
	}
	...
	public static SkillGuide fetchSkillGuide(long guideId) {
		return getService().fetchSkillGuide(guideId);
	}
	 ...
	 * @throws PortalException if a skill guide with the primary key could not be found
	 */
	public static SkillGuide getSkillGuide(long guideId)
		throws PortalException {

		return getService().getSkillGuide(guideId);
	}
	 ...
	 */
	public static List<SkillGuide> getSkillGuides(int start, int end) {
		return getService().getSkillGuides(start, end);
	}
	 ...
	 */
	public static int getSkillGuidesCount() {
		return getService().getSkillGuidesCount();
	}
	 ...
	 */
	public static SkillGuide updateSkillGuide(SkillGuide skillGuide) {
		return getService().updateSkillGuide(skillGuide);
	}

	public static SkillGuideLocalService getService() {
		return _service;
	}

	private static volatile SkillGuideLocalService _service;
