...
public class ClaimConstants {
	...
	public static final String ZENDESK_API_ERROR_STR = "Create claim Zendesk Api...";
	...
	public static final String WRONG_ISBN = "wrongIsbn";
	public static final String CLAIM_HEADER_JSON_OBJECT = "claimHeaderObject";
	public static final String CANCEL_CLAIM_MAPPING = "cancelClaim";
	public static final String CANCEL_CLAIM_STATUS = "CANCELLING";
	public static final String WRONG_BOOK_LABEL = "Wrong book:";
