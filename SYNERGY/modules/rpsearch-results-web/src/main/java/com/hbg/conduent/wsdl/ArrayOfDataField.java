...
/**
 * <p>Java class for ArrayOfDataField complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="DataField" type="{https://hachettearchive.cmcsglobal.com/service}DataField" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ArrayOfDataField", propOrder = {
    "dataField"
})
public class ArrayOfDataField {

    @XmlElement(name = "DataField", nillable = true)
