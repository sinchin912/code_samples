...
/**
 * Provides the local service interface for Probation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProbationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ProbationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.trantorinc.synergy.probation.core.service.impl.ProbationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the probation local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ProbationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Probation addProbation(Probation probation);
	...
	public Probation createProbation(String ecode);
	...
	public Probation deleteProbation(Probation probation);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Probation deleteProbation(String ecode) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Probation fetchProbation(String ecode);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Probation getProbation(String ecode) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Probation> getProbations(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Probation updateProbation(Probation probation);
