...
/**
 * Provides the local service utility for ProbationLine. This utility wraps
 * <code>com.trantorinc.synergy.probation.core.service.impl.ProbationLineLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ProbationLineLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.trantorinc.synergy.probation.core.service.impl.ProbationLineLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ProbationLine addProbationLine(ProbationLine probationLine) {
		return getService().addProbationLine(probationLine);
	}
	 ...
	 */
	public static ProbationLine createProbationLine(long lineId) {
		return getService().createProbationLine(lineId);
	}
	 ...
	 */
	public static ProbationLine deleteProbationLine(long lineId)
		throws PortalException {

		return getService().deleteProbationLine(lineId);
	}
	 ...
	 * @return the probation line that was removed
	 */
	public static ProbationLine deleteProbationLine(
		ProbationLine probationLine) {

		return getService().deleteProbationLine(probationLine);
	}
	...
	public static ProbationLine fetchProbationLine(long lineId) {
		return getService().fetchProbationLine(lineId);
	}

	public static List<ProbationLine> findByProbationId(String probationId) {
		return getService().findByProbationId(probationId);
	}
	 ...
	 * @throws PortalException if a probation line with the primary key could not be found
	 */
	public static ProbationLine getProbationLine(long lineId)
		throws PortalException {

		return getService().getProbationLine(lineId);
	}
	 ...
	 */
	public static List<ProbationLine> getProbationLines(int start, int end) {
		return getService().getProbationLines(start, end);
	}
	 ...
	 */
	public static int getProbationLinesCount() {
		return getService().getProbationLinesCount();
	}
	 ...
	 */
	public static ProbationLine updateProbationLine(
		ProbationLine probationLine) {

		return getService().updateProbationLine(probationLine);
	}

	public static ProbationLineLocalService getService() {
		return _service;
	}

	private static volatile ProbationLineLocalService _service;
