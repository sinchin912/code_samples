 ...
 * @generated
 */
public abstract class ProbationFinderBaseImpl
	extends BasePersistenceImpl<Probation> {

	public ProbationFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return probationPersistence.getBadColumnNames();
	}
