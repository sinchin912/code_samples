...
import com.trantorinc.synergy.email.core.model.EmailTable;
import com.trantorinc.synergy.email.core.model.impl.EmailImpl;
import com.trantorinc.synergy.email.core.model.impl.EmailModelImpl;
import com.trantorinc.synergy.email.core.service.persistence.EmailPersistence;
import com.trantorinc.synergy.email.core.service.persistence.EmailUtil;
 ...
 * @generated
 */
@Component(service = {EmailPersistence.class, BasePersistence.class})
public class EmailPersistenceImpl
	...
	public Email updateImpl(Email email) {
		...
		entityCache.putResult(EmailImpl.class, email, false, true);
	...
	public void activate() {
		...
		_setEmailUtilPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		_setEmailUtilPersistence(null);

		entityCache.removeCache(EmailImpl.class.getName());
	}

	private void _setEmailUtilPersistence(EmailPersistence emailPersistence) {
		try {
			Field field = EmailUtil.class.getDeclaredField("_persistence");

			field.setAccessible(true);

			field.set(null, emailPersistence);
		}
