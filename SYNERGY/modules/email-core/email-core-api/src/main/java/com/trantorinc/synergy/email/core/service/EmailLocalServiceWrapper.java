...
public class EmailLocalServiceWrapper
	 ...
	 */
	@Override
	public com.trantorinc.synergy.email.core.model.Email addEmail(
		com.trantorinc.synergy.email.core.model.Email email) {
	 ...
	 */
	@Override
	public com.trantorinc.synergy.email.core.model.Email createEmail(
		long emailId) {
	 ...
	 */
	@Override
	public com.trantorinc.synergy.email.core.model.Email deleteEmail(
		com.trantorinc.synergy.email.core.model.Email email) {
	...
	@Override
	public com.trantorinc.synergy.email.core.model.Email fetchEmail(
		long emailId) {
	...
	public java.util.List<com.trantorinc.synergy.email.core.model.Email>
		findEmailByOnDate(java.util.Date fromDate, java.util.Date toDate) {

		return _emailLocalService.findEmailByOnDate(fromDate, toDate);
	}

	@Override
	public com.trantorinc.synergy.email.core.model.Email findNextEmail(
		boolean isSent) {

		return _emailLocalService.findNextEmail(isSent);
	}
	 ...
	 */
	@Override
	public com.trantorinc.synergy.email.core.model.Email getEmail(long emailId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public com.trantorinc.synergy.email.core.model.Email updateEmail(
		com.trantorinc.synergy.email.core.model.Email email) {
