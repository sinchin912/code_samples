...
/**
 * Provides the local service utility for ExitState. This utility wraps
 * <code>com.trantorinc.synergy.notice.core.service.impl.ExitStateLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ExitStateLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.trantorinc.synergy.notice.core.service.impl.ExitStateLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ExitState addExitState(ExitState exitState) {
		return getService().addExitState(exitState);
	}
	 ...
	 */
	public static ExitState createExitState(long exitStateId) {
		return getService().createExitState(exitStateId);
	}
	 ...
	 */
	public static ExitState deleteExitState(ExitState exitState) {
		return getService().deleteExitState(exitState);
	}
	 ...
	 */
	public static ExitState deleteExitState(long exitStateId)
		throws PortalException {

		return getService().deleteExitState(exitStateId);
	}
	...
	public static ExitState fetchExitState(long exitStateId) {
		return getService().fetchExitState(exitStateId);
	}
	 ...
	 * @throws PortalException if a exit state with the primary key could not be found
	 */
	public static ExitState getExitState(long exitStateId)
		throws PortalException {

		return getService().getExitState(exitStateId);
	}
	 ...
	 */
	public static List<ExitState> getExitStates(int start, int end) {
		return getService().getExitStates(start, end);
	}
	 ...
	 */
	public static int getExitStatesCount() {
		return getService().getExitStatesCount();
	}
	 ...
	 */
	public static ExitState updateExitState(ExitState exitState) {
		return getService().updateExitState(exitState);
	}

	public static ExitStateLocalService getService() {
		return _service;
	}

	private static volatile ExitStateLocalService _service;
