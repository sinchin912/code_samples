 ...
 */
@ProviderType
public interface QuestionnaireFormFinder {

	public java.util.List
		<com.trantorinc.synergy.notice.core.model.QuestionnaireForm>
			findQuestionnaireFormByResignationId(long resignationId);

	public java.util.List<Object[]> findAllQuestionnaireFormEntries();

	public java.util.List
		<com.trantorinc.synergy.notice.core.model.QuestionnaireForm>
			findYearlyEntries(java.util.Date startDate, java.util.Date endDate);
