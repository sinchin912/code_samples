...
/**
 * Provides the local service interface for HrForm. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see HrFormLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface HrFormLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.trantorinc.synergy.notice.core.service.impl.HrFormLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the hr form local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link HrFormLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public HrForm addHrForm(HrForm hrForm);
	...
	public HrForm createHrForm(long id);
	...
	public HrForm deleteHrForm(HrForm hrForm);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public HrForm deleteHrForm(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public HrForm fetchHrForm(long id);

	public List<HrForm> findHrFormByExitId(long exitFormId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public HrForm getHrForm(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<HrForm> getHrForms(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public HrForm updateHrForm(HrForm hrForm);
