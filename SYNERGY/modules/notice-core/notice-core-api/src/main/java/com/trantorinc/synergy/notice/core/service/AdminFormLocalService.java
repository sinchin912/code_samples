...
/**
 * Provides the local service interface for AdminForm. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AdminFormLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AdminFormLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.trantorinc.synergy.notice.core.service.impl.AdminFormLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the admin form local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AdminFormLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AdminForm addAdminForm(AdminForm adminForm);
	...
	public AdminForm createAdminForm(long id);
	...
	public AdminForm deleteAdminForm(AdminForm adminForm);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AdminForm deleteAdminForm(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AdminForm fetchAdminForm(long id);

	public List<AdminForm> findAdminFormByExitId(long exitFormId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AdminForm getAdminForm(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AdminForm> getAdminForms(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AdminForm updateAdminForm(AdminForm adminForm);
