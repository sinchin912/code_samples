...
/**
 * Provides the local service utility for ItForm. This utility wraps
 * <code>com.trantorinc.synergy.notice.core.service.impl.ItFormLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ItFormLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.trantorinc.synergy.notice.core.service.impl.ItFormLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ItForm addItForm(ItForm itForm) {
		return getService().addItForm(itForm);
	}
	 ...
	 */
	public static ItForm createItForm(long id) {
		return getService().createItForm(id);
	}
	 ...
	 */
	public static ItForm deleteItForm(ItForm itForm) {
		return getService().deleteItForm(itForm);
	}
	 ...
	 */
	public static ItForm deleteItForm(long id) throws PortalException {
		return getService().deleteItForm(id);
	}
	...
	public static ItForm fetchItForm(long id) {
		return getService().fetchItForm(id);
	}

	public static List<ItForm> findItFormByExitId(long exitFormId) {
		return getService().findItFormByExitId(exitFormId);
	}
	 ...
	 * @throws PortalException if a it form with the primary key could not be found
	 */
	public static ItForm getItForm(long id) throws PortalException {
		return getService().getItForm(id);
	}
	 ...
	 */
	public static List<ItForm> getItForms(int start, int end) {
		return getService().getItForms(start, end);
	}
	 ...
	 */
	public static int getItFormsCount() {
		return getService().getItFormsCount();
	}
	 ...
	 */
	public static ItForm updateItForm(ItForm itForm) {
		return getService().updateItForm(itForm);
	}

	public static ItFormLocalService getService() {
		return _service;
	}

	private static volatile ItFormLocalService _service;
