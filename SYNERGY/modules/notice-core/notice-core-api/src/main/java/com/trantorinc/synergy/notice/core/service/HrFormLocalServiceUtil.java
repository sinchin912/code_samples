...
/**
 * Provides the local service utility for HrForm. This utility wraps
 * <code>com.trantorinc.synergy.notice.core.service.impl.HrFormLocalServiceImpl</code> and
 ...
 * @generated
 */
public class HrFormLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.trantorinc.synergy.notice.core.service.impl.HrFormLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static HrForm addHrForm(HrForm hrForm) {
		return getService().addHrForm(hrForm);
	}
	 ...
	 */
	public static HrForm createHrForm(long id) {
		return getService().createHrForm(id);
	}
	 ...
	 */
	public static HrForm deleteHrForm(HrForm hrForm) {
		return getService().deleteHrForm(hrForm);
	}
	 ...
	 */
	public static HrForm deleteHrForm(long id) throws PortalException {
		return getService().deleteHrForm(id);
	}
	...
	public static HrForm fetchHrForm(long id) {
		return getService().fetchHrForm(id);
	}

	public static List<HrForm> findHrFormByExitId(long exitFormId) {
		return getService().findHrFormByExitId(exitFormId);
	}
	 ...
	 * @throws PortalException if a hr form with the primary key could not be found
	 */
	public static HrForm getHrForm(long id) throws PortalException {
		return getService().getHrForm(id);
	}
	 ...
	 */
	public static List<HrForm> getHrForms(int start, int end) {
		return getService().getHrForms(start, end);
	}
	 ...
	 */
	public static int getHrFormsCount() {
		return getService().getHrFormsCount();
	}
	 ...
	 */
	public static HrForm updateHrForm(HrForm hrForm) {
		return getService().updateHrForm(hrForm);
	}

	public static HrFormLocalService getService() {
		return _service;
	}

	private static volatile HrFormLocalService _service;
