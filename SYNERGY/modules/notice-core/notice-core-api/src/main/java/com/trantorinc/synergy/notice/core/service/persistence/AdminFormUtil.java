...
/**
 * The persistence utility for the admin form service. This utility wraps <code>com.trantorinc.synergy.notice.core.service.persistence.impl.AdminFormPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see AdminFormPersistence
 * @generated
 */
public class AdminFormUtil {
	 ...
	 */
	public static void clearCache(AdminForm adminForm) {
		getPersistence().clearCache(adminForm);
	}
	 ...
	 */
	public static Map<Serializable, AdminForm> fetchByPrimaryKeys(
	 ...
	 */
	public static List<AdminForm> findWithDynamicQuery(
	...
	public static List<AdminForm> findWithDynamicQuery(
		DynamicQuery dynamicQuery, int start, int end,
		OrderByComparator<AdminForm> orderByComparator) {
	 ...
	 */
	public static AdminForm update(AdminForm adminForm) {
		return getPersistence().update(adminForm);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static AdminForm update(
		AdminForm adminForm, ServiceContext serviceContext) {

		return getPersistence().update(adminForm, serviceContext);
	}
	 ...
	 */
	public static void cacheResult(AdminForm adminForm) {
		getPersistence().cacheResult(adminForm);
	}
	 ...
	 */
	public static void cacheResult(List<AdminForm> adminForms) {
		getPersistence().cacheResult(adminForms);
	}
	 ...
	 */
	public static AdminForm create(long id) {
	 ...
	 */
	public static AdminForm remove(long id)
		throws com.trantorinc.synergy.notice.core.exception.
			NoSuchAdminFormException {

		return getPersistence().remove(id);
	}

	public static AdminForm updateImpl(AdminForm adminForm) {
		return getPersistence().updateImpl(adminForm);
	}
	 ...
	 * @throws NoSuchAdminFormException if a admin form with the primary key could not be found
	 */
	public static AdminForm findByPrimaryKey(long id)
		throws com.trantorinc.synergy.notice.core.exception.
			NoSuchAdminFormException {
	 ...
	 */
	public static AdminForm fetchByPrimaryKey(long id) {
	 ...
	 */
	public static List<AdminForm> findAll() {
	 ...
	 */
	public static List<AdminForm> findAll(int start, int end) {
	...
	public static AdminFormPersistence getPersistence() {
		return _persistence;
	}

	private static volatile AdminFormPersistence _persistence;
