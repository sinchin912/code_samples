...
/**
 * Provides the local service interface for ExitForm. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ExitFormLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ExitFormLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.trantorinc.synergy.notice.core.service.impl.ExitFormLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the exit form local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ExitFormLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ExitForm addExitForm(ExitForm exitForm);
	...
	public ExitForm createExitForm(long id);
	...
	public ExitForm deleteExitForm(ExitForm exitForm);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ExitForm deleteExitForm(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ExitForm fetchExitForm(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ExitForm getExitForm(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ExitForm> getExitForms(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ExitForm updateExitForm(ExitForm exitForm);
