...
/**
 * Provides the local service interface for FinanceForm. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FinanceFormLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FinanceFormLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.trantorinc.synergy.notice.core.service.impl.FinanceFormLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the finance form local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FinanceFormLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public FinanceForm addFinanceForm(FinanceForm financeForm);
	...
	public FinanceForm createFinanceForm(long id);
	...
	public FinanceForm deleteFinanceForm(FinanceForm financeForm);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public FinanceForm deleteFinanceForm(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FinanceForm fetchFinanceForm(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FinanceForm getFinanceForm(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FinanceForm> getFinanceForms(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public FinanceForm updateFinanceForm(FinanceForm financeForm);
