...
public interface ResignationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.trantorinc.synergy.notice.core.service.impl.ResignationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the resignation local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ResignationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Resignation createResignation(long id);
	...
	public Resignation deleteResignation(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Resignation fetchResignation(long id);

	public List<Resignation> findActiveResignationEntries(Date date);

	public List<Resignation> findActiveResignationsByLastWorkingDate(Date date);
	...
	public List<Resignation> findResignationsByLastWorkingDate(
		Date lastWorkingDay);

	public List<Integer> findUniqueResignationYears();

	public List<Resignation> findYearlyEntriesbyCreationDate(
		Date startDate, Date endDate);

	public List<Resignation> findYearlyEntriesbyLWD(
		Date startDate, Date endDate);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Resignation getResignation(long id) throws PortalException;
