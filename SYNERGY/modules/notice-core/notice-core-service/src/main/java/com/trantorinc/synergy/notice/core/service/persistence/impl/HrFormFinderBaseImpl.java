 ...
 * @generated
 */
public abstract class HrFormFinderBaseImpl extends BasePersistenceImpl<HrForm> {

	public HrFormFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return hrFormPersistence.getBadColumnNames();
	}
