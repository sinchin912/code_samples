 ...
 * @generated
 */
public abstract class AdminFormFinderBaseImpl
	extends BasePersistenceImpl<AdminForm> {

	public AdminFormFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return adminFormPersistence.getBadColumnNames();
	}
