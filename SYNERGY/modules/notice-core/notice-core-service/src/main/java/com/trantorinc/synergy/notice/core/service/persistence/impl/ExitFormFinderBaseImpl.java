 ...
 * @generated
 */
public abstract class ExitFormFinderBaseImpl
	extends BasePersistenceImpl<ExitForm> {

	public ExitFormFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return exitFormPersistence.getBadColumnNames();
	}
