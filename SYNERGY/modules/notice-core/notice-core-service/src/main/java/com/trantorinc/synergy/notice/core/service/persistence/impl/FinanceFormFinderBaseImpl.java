 ...
 * @generated
 */
public abstract class FinanceFormFinderBaseImpl
	extends BasePersistenceImpl<FinanceForm> {

	public FinanceFormFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return financeFormPersistence.getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FinanceFormFinderBaseImpl.class);
