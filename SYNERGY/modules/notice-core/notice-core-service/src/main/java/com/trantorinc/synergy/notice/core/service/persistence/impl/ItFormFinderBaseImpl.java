 ...
 * @generated
 */
public abstract class ItFormFinderBaseImpl extends BasePersistenceImpl<ItForm> {

	public ItFormFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return itFormPersistence.getBadColumnNames();
	}
