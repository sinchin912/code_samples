 ...
 * @generated
 */
public abstract class ResignationFinderBaseImpl
	extends BasePersistenceImpl<Resignation> {

	public ResignationFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return resignationPersistence.getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ResignationFinderBaseImpl.class);
