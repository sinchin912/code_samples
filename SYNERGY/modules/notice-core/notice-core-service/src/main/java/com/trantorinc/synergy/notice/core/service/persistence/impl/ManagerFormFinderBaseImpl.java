 ...
 * @generated
 */
public abstract class ManagerFormFinderBaseImpl
	extends BasePersistenceImpl<ManagerForm> {

	public ManagerFormFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return managerFormPersistence.getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ManagerFormFinderBaseImpl.class);
