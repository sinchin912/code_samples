 ...
 * @generated
 */
public abstract class QuestionnaireFormFinderBaseImpl
	extends BasePersistenceImpl<QuestionnaireForm> {

	public QuestionnaireFormFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return questionnaireFormPersistence.getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		QuestionnaireFormFinderBaseImpl.class);
