...
/**
 * The arguments resolver class for retrieving value from Expense.
 *
 * @author Brian Wing Shun Chan
 * @generated
 */
@Component(service = ArgumentsResolver.class)
public class ExpenseModelArgumentsResolver implements ArgumentsResolver {
	...
	public Object[] getArguments(
		...
		if (finderPathColumnBitmask == null) {
			...
			for (String columnName : columnNames) {
				finderPathColumnBitmask |= expenseModelImpl.getColumnBitmask(
					columnName);
			}

			if (finderPath.isBaseModelResult() &&
				(ExpensePersistenceImpl.
	...
	public String getClassName() {
		return ExpenseImpl.class.getName();
	}

	@Override
	public String getTableName() {
		return ExpenseTable.INSTANCE.getTableName();
	}
