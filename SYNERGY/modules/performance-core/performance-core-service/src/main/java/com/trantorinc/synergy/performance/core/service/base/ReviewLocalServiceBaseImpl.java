...
import com.trantorinc.synergy.performance.core.service.ReviewLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.trantorinc.synergy.performance.core.service.impl.ReviewLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.trantorinc.synergy.performance.core.service.impl.ReviewLocalServiceImpl
 * @generated
 */
public abstract class ReviewLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, ReviewLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ReviewLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ReviewLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return reviewPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Review.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return reviewPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return reviewPersistence.countWithDynamicQuery(
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(reviewLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Review.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(reviewLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Review.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return reviewPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ReviewLocalServiceImpl#deleteReview(Review) to avoid orphaned data");
		}

		return reviewLocalService.deleteReview((Review)persistedModel);
	}

	@Override
	public BasePersistence<Review> getBasePersistence() {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ReviewLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		reviewLocalService = (ReviewLocalService)aopProxy;

		_setLocalServiceUtilService(reviewLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ReviewLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = ReviewLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, reviewLocalService);
		}
	...
	protected ReviewLocalService reviewLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ReviewLocalServiceBaseImpl.class);
