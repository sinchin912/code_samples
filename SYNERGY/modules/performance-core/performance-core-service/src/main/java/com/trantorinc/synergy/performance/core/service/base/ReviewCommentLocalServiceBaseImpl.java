...
import com.trantorinc.synergy.performance.core.service.ReviewCommentLocalService;
...
/**
 * Provides the base implementation for the review comment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.trantorinc.synergy.performance.core.service.impl.ReviewCommentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.trantorinc.synergy.performance.core.service.impl.ReviewCommentLocalServiceImpl
 * @generated
 */
public abstract class ReviewCommentLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, ReviewCommentLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ReviewCommentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ReviewCommentLocalServiceUtil</code>.
	 */
	...
	public ReviewComment addReviewComment(ReviewComment reviewComment) {
		...
		return reviewCommentPersistence.update(reviewComment);
	}
	...
	public ReviewComment createReviewComment(long commentId) {
		return reviewCommentPersistence.create(commentId);
	}
	...
	public ReviewComment deleteReviewComment(long commentId)
		...
		return reviewCommentPersistence.remove(commentId);
	}
	...
	public ReviewComment deleteReviewComment(ReviewComment reviewComment) {
		return reviewCommentPersistence.remove(reviewComment);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return reviewCommentPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ReviewComment.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return reviewCommentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return reviewCommentPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return reviewCommentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return reviewCommentPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ReviewComment fetchReviewComment(long commentId) {
		return reviewCommentPersistence.fetchByPrimaryKey(commentId);
	}
	...
	public ReviewComment getReviewComment(long commentId)
		...
		return reviewCommentPersistence.findByPrimaryKey(commentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(reviewCommentLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ReviewComment.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			reviewCommentLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ReviewComment.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return reviewCommentPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ReviewCommentLocalServiceImpl#deleteReviewComment(ReviewComment) to avoid orphaned data");
		}

		return reviewCommentLocalService.deleteReviewComment(
			(ReviewComment)persistedModel);
	}

	@Override
	public BasePersistence<ReviewComment> getBasePersistence() {
		return reviewCommentPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return reviewCommentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ReviewComment> getReviewComments(int start, int end) {
		return reviewCommentPersistence.findAll(start, end);
	}
	...
	public int getReviewCommentsCount() {
		return reviewCommentPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ReviewCommentLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		reviewCommentLocalService = (ReviewCommentLocalService)aopProxy;

		_setLocalServiceUtilService(reviewCommentLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ReviewCommentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = reviewCommentPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = ReviewCommentLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, reviewCommentLocalService);
		}
	...
	protected ReviewCommentLocalService reviewCommentLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ReviewCommentLocalServiceBaseImpl.class);
