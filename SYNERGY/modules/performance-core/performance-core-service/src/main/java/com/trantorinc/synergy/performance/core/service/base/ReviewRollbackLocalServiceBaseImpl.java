...
import com.trantorinc.synergy.performance.core.service.ReviewRollbackLocalService;
...
/**
 * Provides the base implementation for the review rollback local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.trantorinc.synergy.performance.core.service.impl.ReviewRollbackLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.trantorinc.synergy.performance.core.service.impl.ReviewRollbackLocalServiceImpl
 * @generated
 */
public abstract class ReviewRollbackLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, ReviewRollbackLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ReviewRollbackLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ReviewRollbackLocalServiceUtil</code>.
	 */
	...
	public ReviewRollback addReviewRollback(ReviewRollback reviewRollback) {
		...
		return reviewRollbackPersistence.update(reviewRollback);
	}
	...
	public ReviewRollback createReviewRollback(long rollbackId) {
		return reviewRollbackPersistence.create(rollbackId);
	}
	...
	public ReviewRollback deleteReviewRollback(long rollbackId)
		...
		return reviewRollbackPersistence.remove(rollbackId);
	}
	...
	public ReviewRollback deleteReviewRollback(ReviewRollback reviewRollback) {
		return reviewRollbackPersistence.remove(reviewRollback);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return reviewRollbackPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ReviewRollback.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return reviewRollbackPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return reviewRollbackPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return reviewRollbackPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return reviewRollbackPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ReviewRollback fetchReviewRollback(long rollbackId) {
		return reviewRollbackPersistence.fetchByPrimaryKey(rollbackId);
	}
	...
	public ReviewRollback getReviewRollback(long rollbackId)
		...
		return reviewRollbackPersistence.findByPrimaryKey(rollbackId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(reviewRollbackLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ReviewRollback.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("rollbackId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			reviewRollbackLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ReviewRollback.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("rollbackId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return reviewRollbackPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ReviewRollbackLocalServiceImpl#deleteReviewRollback(ReviewRollback) to avoid orphaned data");
		}

		return reviewRollbackLocalService.deleteReviewRollback(
			(ReviewRollback)persistedModel);
	}

	@Override
	public BasePersistence<ReviewRollback> getBasePersistence() {
		return reviewRollbackPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return reviewRollbackPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ReviewRollback> getReviewRollbacks(int start, int end) {
		return reviewRollbackPersistence.findAll(start, end);
	}
	...
	public int getReviewRollbacksCount() {
		return reviewRollbackPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ReviewRollbackLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		reviewRollbackLocalService = (ReviewRollbackLocalService)aopProxy;

		_setLocalServiceUtilService(reviewRollbackLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ReviewRollbackLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = reviewRollbackPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = ReviewRollbackLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, reviewRollbackLocalService);
		}
	...
	protected ReviewRollbackLocalService reviewRollbackLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ReviewRollbackLocalServiceBaseImpl.class);
