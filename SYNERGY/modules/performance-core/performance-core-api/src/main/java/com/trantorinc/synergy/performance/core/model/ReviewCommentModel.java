...
/**
 * The base model interface for the ReviewComment service. Represents a row in the &quot;PERFORMANCE_ReviewComment&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.trantorinc.synergy.performance.core.model.impl.ReviewCommentModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.trantorinc.synergy.performance.core.model.impl.ReviewCommentImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface ReviewCommentModel extends BaseModel<ReviewComment> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a review comment model instance should use the {@link ReviewComment} interface instead.
	 */
