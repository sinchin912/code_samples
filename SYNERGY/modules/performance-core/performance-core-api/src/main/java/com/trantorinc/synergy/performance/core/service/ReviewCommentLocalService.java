...
/**
 * Provides the local service interface for ReviewComment. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ReviewCommentLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ReviewCommentLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.trantorinc.synergy.performance.core.service.impl.ReviewCommentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the review comment local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ReviewCommentLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ReviewComment createReviewComment(long commentId);
	...
	public ReviewComment deleteReviewComment(long commentId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ReviewComment deleteReviewComment(ReviewComment reviewComment);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ReviewComment fetchReviewComment(long commentId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ReviewComment> getReviewComments(int start, int end);
