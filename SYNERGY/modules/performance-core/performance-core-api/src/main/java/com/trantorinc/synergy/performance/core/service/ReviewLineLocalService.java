...
/**
 * Provides the local service interface for ReviewLine. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ReviewLineLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ReviewLineLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.trantorinc.synergy.performance.core.service.impl.ReviewLineLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the review line local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ReviewLineLocalServiceUtil} if injection and service tracking are not available.
	 */
