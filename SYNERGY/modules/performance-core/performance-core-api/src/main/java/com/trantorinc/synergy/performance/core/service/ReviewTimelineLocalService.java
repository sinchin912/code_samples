...
/**
 * Provides the local service interface for ReviewTimeline. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ReviewTimelineLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ReviewTimelineLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.trantorinc.synergy.performance.core.service.impl.ReviewTimelineLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the review timeline local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ReviewTimelineLocalServiceUtil} if injection and service tracking are not available.
	 */
