...
/**
 * Provides the local service utility for KpiLine. This utility wraps
 * <code>com.trantorinc.synergy.performance.core.service.impl.KpiLineLocalServiceImpl</code> and
 ...
 * @generated
 */
public class KpiLineLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.trantorinc.synergy.performance.core.service.impl.KpiLineLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static KpiLine addKpiLine(KpiLine kpiLine) {
		return getService().addKpiLine(kpiLine);
	}
	 ...
	 */
	public static KpiLine createKpiLine(long lineId) {
		return getService().createKpiLine(lineId);
	}
	 ...
	 */
	public static KpiLine deleteKpiLine(KpiLine kpiLine) {
		return getService().deleteKpiLine(kpiLine);
	}
	 ...
	 */
	public static KpiLine deleteKpiLine(long lineId) throws PortalException {
		return getService().deleteKpiLine(lineId);
	}
	...
	public static KpiLine fetchKpiLine(long lineId) {
		return getService().fetchKpiLine(lineId);
	}

	public static List<KpiLine> findKpiLineByKpiId(long kpiId) {
		return getService().findKpiLineByKpiId(kpiId);
	}
	 ...
	 * @throws PortalException if a kpi line with the primary key could not be found
	 */
	public static KpiLine getKpiLine(long lineId) throws PortalException {
		return getService().getKpiLine(lineId);
	}
	 ...
	 */
	public static List<KpiLine> getKpiLines(int start, int end) {
		return getService().getKpiLines(start, end);
	}
	 ...
	 */
	public static int getKpiLinesCount() {
		return getService().getKpiLinesCount();
	}
	 ...
	 */
	public static KpiLine updateKpiLine(KpiLine kpiLine) {
		return getService().updateKpiLine(kpiLine);
	}

	public static KpiLineLocalService getService() {
		return _service;
	}

	private static volatile KpiLineLocalService _service;
