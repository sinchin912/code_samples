...
public interface ReviewLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.trantorinc.synergy.performance.core.service.impl.ReviewLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the review local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ReviewLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Review deleteReview(long reviewId) throws PortalException;
	...
	public List<Review> findReviewByManager(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Review getReview(long reviewId) throws PortalException;
