...
/**
 * Provides the local service utility for ReviewComment. This utility wraps
 * <code>com.trantorinc.synergy.performance.core.service.impl.ReviewCommentLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ReviewCommentLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.trantorinc.synergy.performance.core.service.impl.ReviewCommentLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ReviewComment addReviewComment(ReviewComment reviewComment) {
		return getService().addReviewComment(reviewComment);
	}
	 ...
	 */
	public static ReviewComment createReviewComment(long commentId) {
		return getService().createReviewComment(commentId);
	}
	 ...
	 */
	public static ReviewComment deleteReviewComment(long commentId)
		throws PortalException {

		return getService().deleteReviewComment(commentId);
	}
	 ...
	 * @return the review comment that was removed
	 */
	public static ReviewComment deleteReviewComment(
		ReviewComment reviewComment) {

		return getService().deleteReviewComment(reviewComment);
	}
	...
	public static ReviewComment fetchReviewComment(long commentId) {
		return getService().fetchReviewComment(commentId);
	}

	public static List<ReviewComment> findReviewCommentByReviewId(
		long reviewId) {

		return getService().findReviewCommentByReviewId(reviewId);
	}
	 ...
	 * @throws PortalException if a review comment with the primary key could not be found
	 */
	public static ReviewComment getReviewComment(long commentId)
		throws PortalException {

		return getService().getReviewComment(commentId);
	}
	 ...
	 */
	public static List<ReviewComment> getReviewComments(int start, int end) {
		return getService().getReviewComments(start, end);
	}
	 ...
	 */
	public static int getReviewCommentsCount() {
		return getService().getReviewCommentsCount();
	}
	 ...
	 */
	public static ReviewComment updateReviewComment(
		ReviewComment reviewComment) {

		return getService().updateReviewComment(reviewComment);
	}

	public static ReviewCommentLocalService getService() {
		return _service;
	}

	private static volatile ReviewCommentLocalService _service;
