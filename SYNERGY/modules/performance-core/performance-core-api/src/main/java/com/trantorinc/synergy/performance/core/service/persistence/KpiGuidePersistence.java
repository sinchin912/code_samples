...
/**
 * The persistence interface for the kpi guide service.
 *
 * <p>
 ...
 */
@ProviderType
public interface KpiGuidePersistence extends BasePersistence<KpiGuide> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link KpiGuideUtil} to access the kpi guide persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public void cacheResult(java.util.List<KpiGuide> kpiGuides);
	 ...
	 */
	public java.util.List<KpiGuide> findAll();
	 ...
	 */
	public java.util.List<KpiGuide> findAll(int start, int end);
	...
	public java.util.List<KpiGuide> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<KpiGuide>
			orderByComparator);
