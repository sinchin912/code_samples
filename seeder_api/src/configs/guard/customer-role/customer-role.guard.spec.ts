...
describe('AdminRoleGuard', () => {
  ...
  beforeEach(async () => {
    ...
    guard = module.get<CustomerRoleGuard>(CustomerRoleGuard);
  });

  it('should return true if user has customer role', () => {
    const mockUser = {
      id: 1,
      name: 'Customer 1',
      username: 'user1',
  ...
  it('should return false if user does not have customer role', () => {
    const mockUser = {
      id: 1,
      name: 'Customer 1',
      username: 'user1',
